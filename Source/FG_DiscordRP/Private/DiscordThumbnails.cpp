...
//
//void UDiscordThumbnails::UpdateThumbnails(FString InStateString, FString InTierString, FString InPresenceString, UDiscordLocalPlayerSubsystem* Discord, UDiscordActivity* Activity, bool& bTutorialException)
//{
//	Assets = NewObject<UDiscordActivityAssets>();
//	Assets->Init();
//
//	// Add small image with tier info
//	Assets->SetSmallImage("satisfactory_logo");
...
//	}
//
//	Discord->Client->UpdateRichPresence(Activity, nullptr);
//}